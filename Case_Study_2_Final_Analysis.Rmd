...
```
So about 16% of employees leave their company voluntarily. This tells us that if we find any group with rates significantly higher or lower than 16% there might be an interesting trend.
...
names_use <- names(analysis_df2)[!names(df_as_character) %in% exclude_names]
